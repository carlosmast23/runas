...
<body>
    ...
    <div class="cabecera">
        <div class="row">
            ...
            <div class="col-sm-4 col-lg-3">
                <p style="text-align: center;">
                    <h2 style="float: left;vertical-align: baseline"><img src="<?= base_url() ?>public/img/iconos/otros/telefono.png"
                            width="40px;" style="vertical-align: baseline;padding-right: 15px;"></img>55 49 22 59 82
                    </h2>
                </p>
            </div>
