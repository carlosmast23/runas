    ...
    <div class="row">
      <div class="col-md-6 col-lg-4">
        <a href="#" class="media-1">
          <img src="images/imagen_home_galeria_1.png" alt="Image" class="img-fluid">
      ...
      <div class="col-md-6 col-lg-4">
        <a href="#" class="media-1">
          <img src="images/imagen_home_galeria_2.png" alt="Image" class="img-fluid">
          <div class="media-1-content">
      ...
      <div class="col-md-6 col-lg-4">
        <a href="#" class="media-1">
          <img src="images/imagen_home_galeria_3.png" alt="Image" class="img-fluid">
          <div class="media-1-content">
