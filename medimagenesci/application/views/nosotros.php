...
<div class="container ">
    <img src="<?= base_url() ?>public/images/RX-1.png" class="img-fluid rounded mx-auto d-block" alt="Responsive image" >
...
Medimágenes ratifica su compromiso con el desarrollo tecnológico brindando el mejor servicio a pacientes y a médicos con diagnósticos oportunos y confiables. Nuestros profesionales médicos constantemente se capacitan en las últimas tecnologías clínicas.
    ...
    <h1 style="text-align: center">Filosofía Empresarial</h1>
    <h2>Visión</h2>
    <p>Ser una empresa líder en el diagnóstico radiológico con vocación docente</p>
    <h2>Misión</h2>
    <p>Somos un centro radiológico en el servicio de la comunidad con calidez humana y excelencia profesional.</p>

    <h1 style="text-align: center">Valores</h1>
    <h2>Ética.</h2>
    <p>Acciones fundamentales en los principios de justicia y autonomía.</p>


    <h2>Profesionalismo.</h2>
    <p>Garantizamos la actualización permanente del recurso humano y tecnológico.</p>

    <h2>Responsabilidad.</h2>
    <p>Orientamos a la prestación de un servicio de cumplimiento de los derechos y deberes del paciente y sus acompañamientos.</p>

    <h2>Calidad.</h2>
    <p>Tenemos la aptitud para satisfacer sus expectativas de servicio.</p>
</div>